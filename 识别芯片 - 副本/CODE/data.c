...
unsigned char lvet_trafpoint_row[5], rvet_trafpoint_row[5], lvet_trafpoint_col[5], rvet_trafpoint_col[5];
unsigned char lvet_trafcount, rvet_trafcount;
unsigned char lef_cut, rig_cut; 
/*----------------------*/
/*	 	 电磁模块		*/
/*======================*/
//	结构体定义
